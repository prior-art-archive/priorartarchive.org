...
class Header extends Component {
	...
	render() {
		...
		const redirectString = `?redirect=${this.props.locationData.path}${this.props.locationData.queryString.length > 1 ? this.props.locationData.queryString : ''}`;
					...
					<div className="row">
						<div className="col-12">
							...
							<div className="headerItems headerItemsRight">
								...
								<a href="/help" className="bp3-button bp3-large bp3-minimal">Help</a>
								<a href="/terms" className="bp3-button bp3-large bp3-minimal">Terms</a>
								<a href="/about" className="bp3-button bp3-large bp3-minimal">About</a>
								{loggedIn &&
									<Popover
										content={
											<Menu>
