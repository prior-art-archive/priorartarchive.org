...
import { renderToNodeStream, getInitialData, handleErrors, generateMetaComponents, operators, searchDefaults } from '../utilities';
...
app.get('/search', (req, res, next)=> {
	...
	.then((initialData)=> {
		...
		const operator = operatorSet.has(params.operator) ? params.operator : searchDefaults.operator;
