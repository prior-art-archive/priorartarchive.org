	...
	return (
		<html lang="en">
			...
			<body>
				...
				<script src="https://cdn.polyfill.io/v2/polyfill.min.js?features=fetch,default,HTMLCanvasElement.prototype.toBlob,Object.entries,Object.values,Array.prototype.@@iterator,Promise.prototype.finally,Array.prototype.find" />
				<script
					id="initial-data"
					type="text/plain"
